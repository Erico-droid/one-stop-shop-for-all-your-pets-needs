...
from .models import User, Vendor, Profile, ServiceProvider, RescueServices, Vet, UserAddress
...
class UserSignUpForm(UserCreationForm):
    ...
    # user_description = forms.CharField(widget=forms.TextInput())
...
class VendorUpdateForm(forms.ModelForm):
    class Meta:
        model = Vendor
        fields = ['image','address','product_category']

class SPUpdateForm(forms.ModelForm):
    class Meta:
        model = ServiceProvider
        fields = ['image','service_information']

class VetUpdateForm(forms.ModelForm):
    class Meta:
        model = Vet
        fields = ['image','experience']
